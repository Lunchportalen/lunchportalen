...
describe("api-allowlist-regression (DC-011)", () => {
  ...
  test("allowlist size matches canonical count (90)", () => {
    ...
    expect(API_AUTH_ALLOWLIST_SIZE).toBe(90);
    expect(API_AUTH_ALLOWLIST.size + API_AUTH_ALLOWLIST_GET_ONLY.size + 4).toBe(90);
  });
