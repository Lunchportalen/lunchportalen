...
function logSanitySnapshotBeforeRollout(label: string): void {
  ...
  console.log(
    "[sammenlign] debug-skript forventet typisk: dataset production, projectId 4udoq5d8 (eller env-styrt NEXT_PUBLIC_SANITY_PROJECT_ID), apiVersion 2024-01-01, useCdn false, token satt",
  );
  console.log("");
}
