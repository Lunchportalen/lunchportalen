          ...
          <div className="grid gap-3">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <div className="lp-kv">
                ...
                <div className="lp-v">{toOsloDateLabel(agreement.end_date ?? (derived.end ? derived.end.toISOString().slice(0, 10) : null))}</div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              ...
              <div className="lp-kv">
                ...
                <div className="lp-v">
                  {derived.noticeDeadline ? derived.noticeDeadline.toLocaleDateString("nb-NO") : "—"}
                </div>
              </div>
            </div>
