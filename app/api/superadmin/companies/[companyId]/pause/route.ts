...
export async function POST(req: NextRequest, ctx: RouteCtx): Promise<Response> {
  ...
  try {
    ...
    if (st === "paused") {
      ...
      return jsonOk(a, { ok: true, rid: a.rid, company, meta: { alreadyPaused: true } }, 200);
    }
    ...
    if (up.error) return jsonErr(500, a, "DB_ERROR", "Kunne ikke pause firma.", up.error);
    ...
    return jsonErr(500, a, "SERVER_ERROR", "Uventet feil i pause.", { message: String(e?.message ?? e) });
  }
}
