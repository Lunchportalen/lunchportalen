...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    if (error) {
      return jsonErr(rid, "esg_build_monthly feilet", 500, { code: "rpc_error", detail: {
    ...
    return jsonErr(rid, "ESG build monthly cron feilet", 500, { code: "server_error", detail: { message: String(e?.message ?? e), month } });
  }
}
