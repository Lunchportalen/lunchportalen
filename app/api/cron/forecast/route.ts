// app/api/cron/forecast/route.ts — K4: deaktivert (lp_generate_forecast_range finnes ikke i migrasjoner)
...
export async function GET(req: Request) {
  ...
  return jsonOk(
    rid,
    {
      ok: true,
      disabled: true,
      reason: "forecast_rpc_not_in_product_scope",
      message: "Forecast-cron er deaktivert (K4).",
    },
    200,
  );
}
