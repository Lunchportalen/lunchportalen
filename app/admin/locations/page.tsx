      ...
      <div className="mx-auto w-full max-w-6xl px-4 py-10 sm:px-6">
        ...
        <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="mt-2 text-neutral-600">Lesemodus. Lokasjoner vises for oversikt og historikk.</p>
          </div>
        ...
        >
          <LocationsPanel companyId={ctx.companyId} readOnly />
          ...
          <div className="mt-6 rounded-2xl bg-neutral-50/70 p-4 ring-1 ring-black/5">
            ...
            <p className="mt-1 text-sm text-neutral-700">
              Endringer i lokasjoner håndteres av superadmin i forbindelse med avtale og leveranseoppsett.
            </p>
          </div>
...
{JSON.stringify(
  ...
  2
        ...
        <div className="mt-10 flex flex-wrap items-center justify-between gap-3 text-xs text-neutral-500">
          <span>Lokasjoner er read-only for kunde-admin. Endringer gjøres av superadmin.</span>
