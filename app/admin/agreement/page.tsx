...
import AgreementBlock from "@/components/admin/AgreementBlock";
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(1200px_700px_at_20%_-10%,rgba(176,139,87,.20),transparent),radial-gradient(1000px_600px_at_100%_10%,rgba(16,185,129,.12),transparent)]">
      <div className="mx-auto w-full max-w-6xl px-4 py-10 sm:px-6">
        ...
        <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <div className="text-xs font-semibold tracking-wide text-neutral-600">
              Admin · {companyName} · Avtale
            </div>
            <h1 className="mt-2 text-3xl font-extrabold tracking-tight text-neutral-900">Avtale</h1>
            <p className="mt-2 text-neutral-600">Lesemodus. Rammene styrer alt — ingen manuelle unntak.</p>
          </div>
        ...
        <SectionCard
          title="Avtalerammer"
          subtitle="Dette er grunnloven for leveransene deres. Endringer håndteres av superadmin."
          right={
            <SupportReportButton
        ...
        >
          <AgreementBlock companyId={ctx.companyId} />


          <div className="mt-6 rounded-2xl bg-neutral-50/70 p-4 ring-1 ring-black/5">
            <div className="text-xs font-semibold tracking-wide text-neutral-700">Viktig</div>
            <ul className="mt-2 space-y-1 text-sm text-neutral-700">
              <li className="flex gap-2">
                <span className="mt-[7px] h-1.5 w-1.5 shrink-0 rounded-full bg-neutral-400" />
                <span>Avtale og cut-off er systemets fasit. Det kan ikke overstyres manuelt.</span>
              </li>
              <li className="flex gap-2">
                <span className="mt-[7px] h-1.5 w-1.5 shrink-0 rounded-full bg-neutral-400" />
                <span>Hvis noe ikke stemmer, send en rapport — så kan drift rette opp riktig vei.</span>
              </li>
            </ul>
          </div>
...
{JSON.stringify(
  ...
  2
        ...
        <div className="mt-10 flex flex-wrap items-center justify-between gap-3 text-xs text-neutral-500">
          <span>Avtale er lesemodus for kunde-admin. Endringer gjøres av superadmin.</span>
