// Editorial HTML + SEO via Umbraco Delivery — Next = renderer only. (Erstatter tidligere /public/demo.)
import {
...
export default async function AiMotorDemoPage({ searchParams }: Props) {
