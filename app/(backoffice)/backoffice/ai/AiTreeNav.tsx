...
const AI_TREE_GROUPS: AiTreeGroup[] = [
  {
    ...
    label: "Control",
    children: [
      { id: "overview", label: "Inntjening / motor", href: "/backoffice/ai/overview" },
      { id: "ai-ceo-control", label: "AI CEO / kontroll", href: "/backoffice/control" },
      { id: "ai-tower", label: "AI Control Tower", href: "/backoffice/ai-control" },
      { id: "control-tower-signals", label: "Control Tower (signaler)", href: "/backoffice/control-tower" },
      { id: "enterprise-dash", label: "Enterprise / inntekt", href: "/backoffice/enterprise" },
      { id: "revenue-engine", label: "Revenue-motor", href: "/backoffice/revenue" },
      { id: "exit-metrics", label: "Exit-metrics", href: "/backoffice/exit" },
      { id: "board-room", label: "Board Room", href: "/backoffice/board" },
      { id: "execution-control", label: "Execution Control", href: "/backoffice/execution" },
      { id: "automation-control", label: "Automation Control", href: "/backoffice/automation" },
      { id: "ipo-mode", label: "IPO-modus", href: "/backoffice/ipo" },
      { id: "acquire-mode", label: "Acquire-modus", href: "/backoffice/acquire" },
      { id: "category-market", label: "Kategori-motor", href: "/backoffice/market" },
      { id: "monopoly-mode", label: "Markedsdominasjon", href: "/backoffice/market/domination" },
      { id: "enterprise-ops", label: "Enterprise Ops", href: "/backoffice/ops" },
      { id: "sdr-workbench", label: "AI SDR (utkast)", href: "/backoffice/sdr" },
      { id: "sales-engine", label: "Sales Engine", href: "/backoffice/sales" },
  ...
  },
  {
    ...
    children: [
      ...
      { id: "ai-config", label: "AI Config", href: "/backoffice/system/ai-config" },
      { id: "ai-prompts", label: "AI Prompts", href: "/backoffice/system/ai-prompts" },
      { id: "autonomy", label: "AI Autonomy", href: "/backoffice/autonomy" },
      { id: "autonomy-optimize", label: "AI Optimization", href: "/backoffice/autonomy/optimize" },
    ],
  },
];
