...
export function ContentWorkspaceEditorModeStrip(props: ContentWorkspaceEditorModeStripProps) {
  ...
  /** På `/backoffice/content/[id]`: fjern pre-canvas onboarding/meta-stack; behold kun nødvendig redigerings-UI. */
  const collapseDetailPreCanvas = isContentDetailRoute;
  ...
  return (
    <>
      ...
      {collapseDetailPreCanvas ? (
        mainView === "preview" ? (
        <div className="flex flex-col gap-1 border-b border-[rgb(var(--lp-border))] bg-white px-2 py-1 sm:flex-row sm:items-center sm:justify-start">
          <div
