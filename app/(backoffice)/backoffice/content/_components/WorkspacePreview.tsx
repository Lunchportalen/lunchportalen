...
export function WorkspacePreview({
  ...
  return (
    <div className="space-y-4">
      <div className="rounded-2xl border border-[rgb(var(--lp-border))] bg-white p-4 shadow-sm sm:p-5">
        <div className="mb-4 flex flex-col gap-2 border-b border-[rgb(var(--lp-border))]/70 pb-4">
          <div>
            <h2 className="text-sm font-semibold uppercase tracking-wide text-[rgb(var(--lp-muted))]">
              Preview
            </h2>
            <p className="mt-1 text-sm text-[rgb(var(--lp-muted))]">
              En egen Bellissima-flate for forhåndsvisning. Ingen delt side-rail, ingen ekstra editorstoy.
            </p>
          </div>
          {historyVersionPreview ? (
            <div
              className="rounded-lg border border-amber-200/80 bg-amber-50/90 px-3 py-2"
              role="status"
              aria-live="polite"
            >
