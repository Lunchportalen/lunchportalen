...
export function ContentWorkspaceGlobalHeaderShell({
  ...
  const headerVariants = [
    ...
    { id: "company-admin" as const, title: "Firma admin header", desc: "Bedriftsadministrator. Faner: Dashboard, Firma, Avtale, Locations, Ansatte, Meny, Innsikt, Historikk.", headerTitle: "Admin", tabs: [{ label: "Dashboard", href: "/admin", exact: true }, { label: "Firma", href: "/admin/companies" }, { label: "Avtale", href: "/admin/agreement" }, { label: "Locations", href: "/admin/locations" }, { label: "Ansatte", href: "/admin/people" }, { label: "Meny", href: "/admin/menus" }, { label: "Innsikt", href: "/admin/insights" }, { label: "Historikk", href: "/admin/history" }] },
    { id: "superadmin" as const, title: "Superadmin header", desc: "Systemadministrasjon. Faner: Kontrollsenter, CFO, Konsern, Firma, Systemhelse, Revisjon.", headerTitle: "Superadmin", tabs: [{ label: "Kontrollsenter", href: "/superadmin", exact: true }, { label: "CFO", href: "/superadmin/cfo" }, { label: "Konsern", href: "/superadmin/enterprise" }, { label: "Firma", href: "/superadmin/companies" }, { label: "Systemhelse", href: "/superadmin/system" }, { label: "Revisjon", href: "/superadmin/audit" }] },
