...
export function ContentWorkspacePropertiesRail(props: ContentWorkspacePropertiesRailProps) {
  ...
  const inspectorTabs =
    workspaceModel?.inspectorSections?.length
      ? workspaceModel.inspectorSections
      : fallbackInspectorTabs;
  ...
  const variantAndScalarsPanel = (
    <section
      className="space-y-3 rounded-xl border border-[rgb(var(--lp-border))] bg-[rgb(var(--lp-card))]/40 p-3"
    ...
    >
      ...
      {page?.body ? (
        <div className="rounded-lg border border-[rgb(var(--lp-border))] bg-white/80 px-2 py-2 text-[11px] text-[rgb(var(--lp-muted))]">
  ...
  const layoutPanel = (
    <section className="space-y-2 rounded-xl border border-[rgb(var(--lp-border))] bg-[rgb(var(--lp-card))]/40 p-3">
      <h3 className="text-xs font-semibold uppercase tracking-wide text-[rgb(var(--lp-muted))]">
  ...
  const listingPanel = (
    <div className="space-y-4 rounded-xl border border-[rgb(var(--lp-border))] bg-white p-4">
      <div>
        <h3 className="text-sm font-semibold text-[rgb(var(--lp-text))]">Listing og sammendrag</h3>
  ...
  const governancePanel = (
    <div className="space-y-4 rounded-xl border border-[rgb(var(--lp-border))] bg-white p-4">
      <h3 className="text-sm font-semibold text-[rgb(var(--lp-text))]">Governance og navigasjon</h3>
      <details className="rounded-xl border border-[rgb(var(--lp-border))] bg-[rgb(var(--lp-card))]/20 p-3" open>
  ...
  const runtimePanel = (
    <div className="space-y-4">
      <div className="rounded-xl border border-[rgb(var(--lp-border))] bg-[rgb(var(--lp-card))]/30 p-4">
        <h3 className="text-sm font-semibold text-[rgb(var(--lp-text))]">Runtime og teknikk</h3>
        <p className="mt-1 text-xs leading-relaxed text-[rgb(var(--lp-muted))]">
          Scripts, tekniske overstyringer og sporbar runtime-kontekst ligger samlet i ett fokusomrade.
        </p>
        <dl className="mt-3 grid gap-2 text-xs sm:grid-cols-2">
          <div className="rounded-lg border border-[rgb(var(--lp-border))] bg-white px-3 py-2">
      ...
      <div className="space-y-6 rounded-xl border border-[rgb(var(--lp-border))] bg-white p-4">
    ...
    <div className="space-y-4">
      <div className="space-y-2">
        ...
        <p className="text-xs leading-relaxed text-[rgb(var(--lp-muted))]">
          Velg ett fokusområde om gangen. Innhold, design, SEO, governance og runtime styres fra samme workspace-kontekst.
        </p>
        <div className="mt-2 flex flex-wrap gap-1.5 border-b border-[rgb(var(--lp-border))] pb-3">
      ...
      {inspectorSection === "seo" ? seoPanel : null}
      {inspectorSection === "governance" ? governancePanel : null}
      {inspectorSection === "runtime" ? runtimePanel : null}
    </div>
  );
}
