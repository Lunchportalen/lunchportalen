      ...
      <div className="relative w-[min(92vw,560px)] rounded-2xl border border-neutral-200 bg-white p-6 shadow-xl" role="dialog" aria-modal="true">
        ...
        {(eligibility?.canArchive || eligibility?.canHardDelete) ? (
          <div className="mt-4 flex flex-wrap gap-2">
            <button
              type="button"
              className={["rounded-full border px-3 py-1.5 text-xs font-semibold", mode === "archive" ? "bg-neutral-900 text-white" : "bg-white hover:bg-neutral-50"].join(" ")}
            ...
            <button
              type="button"
              className={["rounded-full border px-3 py-1.5 text-xs font-semibold", mode === "hard_delete" ? "bg-rose-700 text-white" : "bg-white hover:bg-neutral-50", !eligibility?.canHardDelete ? "opacity-50" : ""].join(" ")}
        ...
        <div className="mt-5 flex justify-end gap-2">
          ...
          {(eligibility?.canArchive && mode === "archive") || (eligibility?.canHardDelete && mode === "hard_delete") ? (
            <button
              type="button"
              className={["rounded-full px-4 py-2 text-sm font-semibold text-white disabled:opacity-50", mode === "hard_delete" ? "bg-rose-700 hover:bg-rose-800" : "bg-neutral-900 hover:bg-neutral-800"].join(" ")}
              onClick={submit}
