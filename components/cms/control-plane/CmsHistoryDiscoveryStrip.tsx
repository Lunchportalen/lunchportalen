...
export function CmsHistoryDiscoveryStrip() {
  ...
  return (
    <details
      className="group shrink-0 rounded-2xl border border-[rgb(var(--lp-border))]/75 bg-[rgba(var(--lp-surface-rgb),0.78)] text-[11px] leading-snug text-[rgb(var(--lp-muted))] shadow-[var(--lp-shadow-sm)] sm:px-0"
    ...
    >
      <summary className="min-h-11 cursor-pointer list-none px-4 py-2 marker:content-none sm:px-6 [&::-webkit-details-marker]:hidden">
        <span className="font-semibold text-[rgb(var(--lp-text))]">Historikk & publish</span>
        <span className="text-[rgb(var(--lp-muted))]"> · kilder og spor</span>
      </summary>
      <div className="mx-auto flex max-w-[1440px] flex-col gap-2 px-4 pb-3 pt-1 sm:px-6">
        <div className="flex flex-col gap-1 sm:flex-row sm:flex-wrap sm:items-baseline sm:gap-x-3">
          <span className="shrink-0 font-semibold text-[rgb(var(--lp-text))]">Historikk & publish</span>
          <span className="min-w-0 text-[rgb(var(--lp-muted))]">
            Det finnes <strong className="font-medium text-[rgb(var(--lp-text))]">ikke én teknisk tidslinje</strong> for alt — kildene
        ...
        >
          <div className="rounded-2xl border border-[rgb(var(--lp-border))]/75 bg-[rgba(var(--lp-surface-rgb),0.84)] px-3 py-2 shadow-[var(--lp-shadow-sm)]">
            <p className="font-semibold text-[rgb(var(--lp-text))]">Spor A · Public / redaksjonelle sider</p>
          ...
          <div className="rounded-2xl border border-[rgb(var(--lp-border))]/75 bg-[rgba(var(--lp-surface-rgb),0.84)] px-3 py-2 shadow-[var(--lp-shadow-sm)]">
            <p className="font-semibold text-[rgb(var(--lp-text))]">Spor B · Meny (Sanity)</p>
            <p className="mt-1 text-[rgb(var(--lp-muted))]">
              Versjonshistorikk i{" "}
              <a
                className="font-medium text-[rgb(var(--lp-text))] underline underline-offset-2"
                href={studioUrl}
                target="_blank"
          ...
          <div className="rounded-2xl border border-[rgb(var(--lp-border))]/75 bg-[rgba(var(--lp-surface-rgb),0.84)] px-3 py-2 shadow-[var(--lp-shadow-sm)]">
            <p className="font-semibold text-[rgb(var(--lp-text))]">Spor C · Uke & meny</p>
            <p className="mt-1 text-[rgb(var(--lp-muted))]">
        ...
        <ul className="list-inside list-disc space-y-0.5 text-[rgb(var(--lp-muted))] sm:ml-1">
          <li>
            <strong className="font-medium text-[rgb(var(--lp-text))]">Public / redaksjonelle sider:</strong> recovery/gjennomgang og
            variantarbeid i{" "}
            <Link className="font-medium text-[rgb(var(--lp-text))] underline underline-offset-2" href="/backoffice/content">
              innholdsworkspace
            </Link>
          ...
          <li>
            <strong className="font-medium text-[rgb(var(--lp-text))]">Meny / Sanity:</strong>{" "}
            <a
              className="font-medium text-[rgb(var(--lp-text))] underline underline-offset-2"
              href={studioUrl}
              target="_blank"
