  ...
  return (
    <header className="lp-topbar border-b border-[rgb(var(--lp-border))] lp-glass-nav">
      <div className="lp-container lp-topbar-inner">
        <div className="flex min-w-0 items-center gap-4">
          <Link href="/" aria-label="Gå til forsiden" className="inline-flex items-center focus:outline-none">
            <Image
              ...
              className="h-14 md:h-24 w-auto max-h-24 object-contain"
              priority
            />
          </Link>

          <span className="font-ui hidden md:inline-block text-xs font-semibold uppercase tracking-wide text-[rgb(var(--lp-muted))]">
            {areaLabel}
          </span>
        </div>
        ...
        <div className="lp-topbar-slot lp-actions">
          <span className="font-ui rounded-full border border-[rgb(var(--lp-border))] bg-white/70 px-3 py-1.5 text-xs font-semibold text-[rgb(var(--lp-text))]">
            Ikke innlogget
          </span>
