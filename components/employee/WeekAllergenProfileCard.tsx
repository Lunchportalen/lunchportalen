...
export default function WeekAllergenProfileCard() {
  ...
  return (
    <section className="mb-6 rounded-[1.75rem] bg-white/90 px-4 py-5 text-center shadow-[0_12px_40px_rgba(24,20,16,0.06)] ring-1 ring-black/5">
      <p className="mx-auto max-w-md text-sm leading-6 text-neutral-700">
