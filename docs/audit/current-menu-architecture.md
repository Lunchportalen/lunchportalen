...
- CLI-config har `projectId: 4udoq5d8`, `dataset: production`, `autoUpdates: false` (`studio/sanity.cli.ts`, `studio/lunchportalen-studio/sanity.config.ts`). **P3.H3-REVERSE (2026-05-19):** commit e3745326 incorrectly pointed repo at empty `f3vuhd2f`; reverted — canonical matches Vercel Production and live CMS data on `4udoq5d8`.
