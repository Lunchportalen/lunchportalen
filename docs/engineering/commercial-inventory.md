...
| R4E-1 — Provider menu API `pricePreview` behind `LP_PROVIDER_PRICE_PREVIEW_DISPLAY` | Done (optional diagnostics; `prices` unchanged; no UI) |
| R4E-2 — Provider menu read-only preview UI strip | Planned |
