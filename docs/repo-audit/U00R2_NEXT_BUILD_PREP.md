...
- Decide whether `global_content` stays a parallel management truth or is explicitly treated as a separate CMS subsystem.
...
21. `app/api/content/global/settings/route.ts`
22. `supabase/migrations/20260421000000_global_content.sql`
...
- `global_content` management-vs-delivery posture
