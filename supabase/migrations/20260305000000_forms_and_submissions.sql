...
create index forms_env_locale_idx on public.forms (environment, locale);
...
create index submissions_form_created_idx on public.form_submissions (form_id, created_at desc);
create index submissions_env_locale_created_idx on public.form_submissions (environment, locale, created_at desc);
