-- FASE 13-IMPL-3D: ENTERPRISE price branch in tg_orders_hydrate_core_fields.
-- ENTERPRISE rows previously fell through to price_per_meal_nok (BASIS tier price).
-- Idempotent column add: column introduced in tier_per_day_v2; retained for stale DBs.
