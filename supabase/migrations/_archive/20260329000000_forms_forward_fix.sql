-- Corrective forward fix: ensure public.forms (and form_submissions) exist for /api/backoffice/forms.
-- Idempotent: safe when 20260305000000_forms_and_submissions was applied or skipped.
-- Scope: forms only. No content tree, media, or other tables.
