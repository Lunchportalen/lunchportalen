-- lp_order_set: MSDI lookup alias varmmat → varmrett
-- Baseline: prod public.lp_order_set via pg_get_functiondef (hkpoky), captured 2026-05-31.
-- Delta: v_slug_msdi for menu_service_day_items match only; day_choices.choice_key stays v_choice_raw.
-- Regenerate: node scripts/ci/generate-lp-order-set-varmmat-migration.mjs <prod_def.sql>
