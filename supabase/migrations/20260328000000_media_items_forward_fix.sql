-- Corrective forward fix: ensure public.media_items exists for /api/backoffice/media/items.
-- Idempotent: safe when 20260309000000_media_items was applied or skipped.
-- Scope: media_items only. No content tree, forms, or other tables.

-- Table (matches 20260309000000 schema; mediaItemSelectColumns in lib/media/normalize.ts)
