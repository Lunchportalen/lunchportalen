...
create index ai_suggestions_created_at_idx on public.ai_suggestions (created_at desc);
create index ai_suggestions_page_variant_idx on public.ai_suggestions (page_id, variant_id, created_at desc);
