/**
 * Fail-closed helpers for Sanity `menuDay` in live surfaces.
 ...
 * Used for employee UI and order gates, not for the superadmin admin list.
 */
export function menuDayHasDisplayableCopy(
