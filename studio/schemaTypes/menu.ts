...
export default defineType({
  ...
  fields: [
    defineField({
      ...
      options: {
        list: [
          { value: "paasmurt", title: "Påsmurt" },
          { value: "salat", title: "Salat" },
          { value: "sushi", title: "Sushi" },
          { value: "pokebowl", title: "Pokebowl" },
          { value: "thai", title: "Thaimat" },
        ],
      },
      ...
      of: [
        {
          ...
          fields: [
            ...
            defineField({ name: "isVegetarian", title: "Vegetar", type: "boolean", initialValue: false }),
            defineField({ name: "isVegan", title: "Vegansk", type: "boolean", initialValue: false }),
            defineField({ name: "isGlutenFree", title: "Glutenfri", type: "boolean", initialValue: false }),
            defineField({ name: "isLactoseFree", title: "Laktosefri", type: "boolean", initialValue: false }),
            defineField({ name: "isHalal", title: "Halal", type: "boolean", initialValue: false }),
            defineField({
              name: "allergens",
              title: "Allergener",
              type: "array",
